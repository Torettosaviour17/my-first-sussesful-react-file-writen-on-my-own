...
const signin = () => {
  return (
    <div>
      ...
      >
        <div className="w-1/2 h-[100%] hidden   opacity-80 sm:flex items-center justify-center bg-[green] text-white">
          {/* Adjusted opacity */}
        ...
        <div className="w-full flex items-center justify-center sm:w-1/2 h-[100%] bg-[#D9D9D9]">
          <div className="bg-white rounded-xl flex flex-col space-y-5 items-center justify-center h-[90%] min-w-[15rem] w-[25rem]">
            <div className="space-y-3 w-[90%] h-[90%]">
              <h1 className="font-bold text-[30px] text-[#00A651]">
                Create an account
              </h1>
              ...
              <div className="">
                ...
                <div className="border-2 rounded-[5px] border-[#353535] w-[100%] h-[2.8rem]">
                  <input
                    className="w-full px-2 rounded-[5px] h-10 outline-none "
                    type="text"
              ...
              <div className="h-16 w-full flex items-center flex-row justify-center gap-3">
                <div className="h-10 w-[25%] flex items-center justify-center border-2">
