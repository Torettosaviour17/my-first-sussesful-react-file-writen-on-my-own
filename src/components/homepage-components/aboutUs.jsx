    ...
    <div>
      <section className="px-12">
        <div className="flex justify-center items-center">
          <h1 className="bg-[#00A651] px-2 py-2 my-8 text-white text-4xl hover:bg-white hover:text-[#00A651] font-bold ">ABOUT US</h1>
        </div>
        {/* <hr className="w-full h-1 bg-black border-0"/> */}
        <div className=" md:flex justify-around w-fill md:p-12">
          <div className="w-full md:w-1/2">
            <img className="w-[95%] h-[75vh] rounded-xl object-cover" src={deliveryGuys} alt="" />
          </div>
