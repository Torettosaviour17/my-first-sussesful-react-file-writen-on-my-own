      ...
      <section style={{ backgroundImage: `url(${heroBackground})` }} className='bg-no-repeat bg-cover bg-center object-cover flex p-10  justify-around items-center bg-[green] px-12 py-3 w-[100%] space-x-4'>
        <div className='md:w-1/2 w-full text-center md:text-left'>
            ...
            <div className='w-full'>
                <input type="text" className=' px-3 md:px-5 text-sm sm:text-md md:text-xl font-normal py-2 sm:py-3 md:py-4 w-[60%] rounded-tl-lg rounded-bl-lg' placeholder='Enter your waybill number'/>
                <button className='w-[20%] bg-black text-sm sm:text-md md:text-xl text-white font-bold py-2 sm:py-3 md:py-4 rounded-tr-lg rounded-br-lg'>
                Track
                </button>
            </div>
        </div>
